...
echo "Employee total wage for current month : " $(( totalWorkHours * EMPLOYEE_PER_HOUR_RATE ))  #Print monthly salary
echo "Each day wages are : "${daily_Wage_Array[@]}									   #Print array containing each day's wage
